...
def main():
    parser = argparse.ArgumentParser(description="Launch sync-buffer block-wise TB training with torchrun/DDP.")
    parser.add_argument("--num_gpus", type=int, default=None)
    parser.add_argument("--gpus", type=str, default=None, help="Comma-separated physical GPU IDs, e.g. 0,1,2,3.")
    parser.add_argument("--master_port", type=int, default=29503)
